 ...
 * @param {Boolean} [options.removeNormals=false] Remove all normals information.
...
function obj2gltf(objPath, gltfPath, options) {
    ...
    var removeNormals = defaultValue(options.removeNormals, defaults.removeNormals);
...
obj2gltf.defaults = {
    ...
    removeNormals: false,
    /**
     * Gets or sets whether the normals data will be removed from the model.
     * @type Boolean
     * @default false
     */
    ao: false,
